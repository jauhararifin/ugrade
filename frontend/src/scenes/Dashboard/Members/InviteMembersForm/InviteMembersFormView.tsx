...
export interface InviteMembersFormViewProps
  extends FormikProps<InviteMembersFormValue> {
  availablePermissions: UserPermission[]
  givablePermissions: UserPermission[]
  predifinedPermissions: { [label: string]: UserPermission[] }
}

export const InviteMembersFormView: FunctionComponent<
...
> = ({
  ...
  const handleChangePermission: React.ChangeEventHandler<
    HTMLInputElement
  > = e => {
