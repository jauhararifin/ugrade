...
export const ResetPasswordFormView: React.FunctionComponent<ResetPasswordFormViewProps> = ({
  handleSubmit,
  handleBlur,
  handleChange,
  values,
  ...
  <form onSubmit={handleSubmit}>
    <Card className='reset-password-panel'>
      ...
      <FormGroup
        ...
        intent={touched.oneTimeCode && errors && errors.oneTimeCode ? Intent.DANGER : Intent.NONE}
      >
        <InputGroup
          name='oneTimeCode'
      ...
      <FormGroup
        ...
        intent={touched.password && errors && errors.password ? Intent.DANGER : Intent.NONE}
      >
        <InputGroup
          name='password'
          type='password'
