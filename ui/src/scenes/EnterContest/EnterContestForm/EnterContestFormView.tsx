...
export const EnterContestFormView: React.FunctionComponent<EnterContestFormViewProps> = ({
  handleSubmit,
  handleChange,
  handleBlur,
  values,
  ...
  <form className='enter-contest-panel' onSubmit={handleSubmit}>
    <Card>
      ...
      <FormGroup
        ...
        intent={submitCount && errors && errors.contestId ? Intent.DANGER : Intent.NONE}
      >
        <InputGroup
          name='contestId'
          large={true}
