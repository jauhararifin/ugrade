...
import { ProblemType } from 'ugrade/services/problem'
  ...
  return (
    <form onSubmit={handleSubmit} className='problem-editor-form'>
      <FormGroup
        ...
        intent={
          touched.shortId && errors && errors.shortId
            ? Intent.DANGER
            : Intent.NONE
        }
      >
      ...
      <FormGroup
        ...
        intent={
          touched.statement && errors && errors.statement
            ? Intent.DANGER
            : Intent.NONE
        }
      >
      ...
      <FormGroup
        ...
        intent={
          touched.type && errors && errors.type ? Intent.DANGER : Intent.NONE
        }
      >
        <HTMLSelect
          name='type'
          options={[
            {
              label: 'Batch',
              value: ProblemType.PROBLEM_TYPE_BATCH,
            },
            {
              label: 'Interactive',
              value: ProblemType.PROBLEM_TYPE_INTERACTIVE,
            },
          ]}
          onChange={handleChange}
          value={values.type}
      ...
      <FormGroup
        ...
        intent={
          touched.timeLimit && errors && errors.timeLimit
            ? Intent.DANGER
            : Intent.NONE
        }
      >
      ...
      <FormGroup
        ...
        intent={
          touched.memoryLimit && errors && errors.memoryLimit
            ? Intent.DANGER
            : Intent.NONE
        }
      >
      ...
      <FormGroup
        ...
        intent={
          touched.outputLimit && errors && errors.outputLimit
            ? Intent.DANGER
            : Intent.NONE
        }
      >
