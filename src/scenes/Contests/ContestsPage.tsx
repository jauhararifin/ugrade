  ...
  <div className="contests-page">
    ...
    <div className="contests-panel">
      <div className="contests-navigation">
        <SidebarMiniCard className={classnames({"bp3-skeleton": contests.length === 0})}>
          <H5>Server Clock</H5>
          <H2>{serverClock ? moment(serverClock).format("HH:mm:ss") : "Unknown"}</H2>
        </SidebarMiniCard>
        <div className={classnames({"bp3-skeleton": contests.length === 0}, "contests-tips")}>
